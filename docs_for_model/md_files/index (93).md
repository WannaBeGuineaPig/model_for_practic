...
![Рисунок Окно создания нового пользователя](media/U-1.png)
...
![Рисунок 8 Пример заполнения обязательных полей](media/U-4.png)
...
![Рисунок Управление пользователями](./media/image6.png)
...
![Рисунок Создание доменной учетной записи](media/U-2.png)
...
![Рисунок 13 Интерфейс для выбора ролей сотруднику](media/U-3.png)
