...
Чтобы заполнить обязательные поля "Орг. правовая форма(ОКОПФ)" и "Тип контрагента" необходимо заполнить справочники [Формы собственности](../Формы собственности/index.md) и "Типы контрагентов" соответственно.
