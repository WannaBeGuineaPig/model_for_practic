...
Для входа в документ необходимо в меню в поисковой строке ввести "**Должности организации**". Для доступа к документу нужны права администратора.

![Рисунок 1 Меню](media/reestr.png)
